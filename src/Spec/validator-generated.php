...
class ValidationRulesFactory {
  public static function createValidationRules() {
    ...
    $o_0->tags[] = $o_1321;
    $o_1327 = new TagSpec();
    $o_1327->tag_name = 'script';
    $o_1328 = new AttrSpec();
    $o_1328->name = 'async';
    $o_1328->mandatory = true;
    $o_1328->value = '';
    $o_1327->attrs[] = $o_1328;
    $o_1329 = new AttrSpec();
    $o_1329->name = 'custom-element';
    $o_1329->mandatory = true;
    $o_1329->value = 'amp-consent';
    $o_1329->dispatch_key = true;
    $o_1327->attrs[] = $o_1329;
    $o_1330 = new AttrSpec();
    $o_1330->name = 'src';
    $o_1330->mandatory = true;
    $o_1330->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-consent-(latest|0\\.1).js';
    $o_1327->attrs[] = $o_1330;
    $o_1331 = new AttrSpec();
    $o_1331->name = 'type';
    $o_1331->value = 'text/javascript';
    $o_1327->attrs[] = $o_1331;
    $o_1327->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-consent.html';
    $o_1332 = new CdataSpec();
    $o_1333 = new BlackListedCDataRegex();
    $o_1333->regex = '.';
    $o_1333->error_message = 'contents';
    $o_1332->blacklisted_cdata_regex[] = $o_1333;
    $o_1327->cdata = $o_1332;
    $o_0->tags[] = $o_1327;
    return $o_0;
  }
